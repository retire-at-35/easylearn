...
public class JudgeQuestionController {
    ...
    public Result getPage(@RequestParam(defaultValue = "1") Integer page,
        ...
        PageBean pageBean=questionService.getPage(page,pageSize,cid,sid,content, Constant.JUDGE_QUESTION_TYPE);
        return Result.success(pageBean);
    }

    @PostMapping("/addOrUpdateQuestion")
    public Result addSingleQuestion(@RequestBody QuestionDto questionDto){
        questionService.addQuestion(questionDto,Constant.JUDGE_QUESTION_TYPE);
